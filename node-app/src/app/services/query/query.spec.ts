...
describe('query service', () => {
    ...
    it('should mock get all data with limit', (done) => {
        services.getAll(models.users, {}, {'limit': 1})
            .then(
                (data) => {
    ...
    it('should get the query request', (done) => {
        expect(services.appendRequestQuery({}, 'ENName:LTL|TCName:XXX')).to.have.eql({ 'ENName': {}, 'TCName': {} });
