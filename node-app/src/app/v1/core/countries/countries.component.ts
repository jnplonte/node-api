...
export class Countries extends CoreInterface {
    pageCache: any;
    ...
    all(req: Request, res: Response): void {
        ...
        return this.query.getAll(req.models.countries, whereData, req.query)
            .then(
                (countries: any) => {
    ...
    get(req: Request, res: Response): void {
        ...
        return this.query.getOne(req.models.countries, whereData, req.query.key, req.params.id)
            .then(
                (country: CountriesAttributes) => this.response.success(res, 'get', country || {})
            )
            .catch(
                (error) => this.response.failed(res, 'get', error)
            );
    ...
    post(req: Request, res: Response): void {
        ...
        return this.query.post(req.models.countries, data)
            .then(
                (country: CountriesAttributes) => this.cacheCheck(this.pageCache, this.nameCache)((country) ? this.response.success(res, 'post', country.id) : this.response.failed(res, 'post'))
            )
            .catch(
    ...
    put(req: Request, res: Response): void {
        ...
        return this.query.put(req.models.countries, data, whereData)
            .then(
                (country: number[]) => this.cacheCheck(this.pageCache, this.nameCache)((country[0]) ? this.response.success(res, 'put', id) : this.response.failed(res, 'put'))
            )
            .catch(
    ...
    delete(req: Request, res: Response): void {
        ...
        return this.query.delete(req.models.countries, whereData)
            .then(
                (country: number) => this.cacheCheck(this.pageCache, this.nameCache)((country) ? this.response.success(res, 'delete', id) : this.response.failed(res, 'delete'))
            )
            .catch(
