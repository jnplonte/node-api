...
export class Users extends CoreInterface {
    ...
    get attributes(): any {
        return { 'exclude': ['salt', 'password', 'forgotPasswordKey', 'verificationKey', 'socialMediaKey', 'createdUserId', 'updatedUserId'] };
    }
    ...
    all(req: Request, res: Response): void {
        ...
        return this.query.getAll(req.models.users, whereData, req.query)
            .then(
                (users: any) => {
    ...
    get(req: Request, res: Response): void {
        ...
        return this.query.getOne(req.models.users, whereData, req.query.key, req.params.id)
            .then(
                (user: UsersAttributes) => this.response.success(res, 'get', user || {})
            )
            .catch(
                (error) => this.response.failed(res, 'get', error)
            );
    ...
    getMe(req: Request, res: Response): void {
        ...
        return this.query.getOne(req.models.users, whereData)
            .then(
                (user: UsersAttributes) => this.response.success(res, 'get', user || {})
            )
            .catch(
    ...
    post(req: Request, res: Response): void {
        ...
        return this.query.post(req.models.users, data)
            .then(
                (user: UsersAttributes) => this.cacheCheck(this.pageCache, this.nameCache)((user) ? this.response.success(res, 'post', user.id) : this.response.failed(res, 'post'))
            )
            .catch(
    ...
    put(req: Request, res: Response): void {
        ...
        return this.query.put(req.models.users, data, whereData)
            .then(
                (user: number[]) => this.cacheCheck(this.pageCache, this.nameCache)((user[0]) ? this.response.success(res, 'put', id) : this.response.failed(res, 'put'))
            )
            .catch(
    ...
    delete(req: Request, res: Response): void {
        ...
        return this.query.put(req.models.users, {'active': false, 'updatedUserId': req.authentication.id || null}, whereData)
            .then(
                (users: number[]) => this.cacheCheck(this.pageCache, this.nameCache)((users[0]) ? this.response.success(res, 'delete', id) : this.response.failed(res, 'delete'))
            )
            .catch(
