...
export = {
	up: (queryInterface: QueryInterface, Sequelize: any) => queryInterface.createTable('users', {
		id: {
			allowNull: false,
			primaryKey: true,
			type: Sequelize.UUID,
	...
	down: (queryInterface: QueryInterface, Sequelize: any) => queryInterface.dropTable('users')
};
